...
<%
kltool_admin
if ObjTest("Persits.Jpeg",0)=False then
	Response.write kltool_head("Asp Jpeg不支持",0)&kltool_alert("Asp Jpeg图片处理(图片操作):<br/>"&ObjTest("Persits.Jpeg",1))&kltool_end(0)
	Response.End()
end if
if ObjTest("Microsoft.XMLHTTP",0)=False then
	Response.write kltool_head("XMLHTTP不支持",0)&kltool_alert("Http 组件(并非很重要):<br/>"&ObjTest("Microsoft.XMLHTTP",1))&kltool_end(0)
	Response.End()
end if
